    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-auto mb-xl-5  pb-xl-5 mb-sm-0 pb-sm-0 mb-0 pb-0 align-self-center ">
                <img src="<?php bloginfo('template_directory'); ?>./Assets/Images/element2home.png" alt="">
            </div>
            <div class="col">
                        ...
                        <div class="selector ">
                           <?php echo do_shortcode('[contact-form-7 id="375" title="Contact form 1"]'); ?>
                            ...
                            <div class="d-flex justify-content-end">
                                <img src="<?php bloginfo('template_directory'); ?>./Assets/Images/element1home.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-lg-6 col-md-12 image ">
                        <img src="<?php bloginfo('template_directory'); ?>./Assets/Images/element3home.png" alt="">
        ...
        <div class="row second pt-5">
            ...
            <div
                ...
                <div class="d-flex justify-content-end mx-5 px-5">
                    <img class="mx-5 px-5" src="<?php bloginfo('template_directory'); ?>./Assets/Images/element1home.png" alt="" srcset="">
        ...
        <div class="container trending my-5 py-5">
            <div class="row mx-5  ">
                <div class="col-xxl col-lg-6 col-md-12  d-flex justify-content-md-center justify-content-lg-start justify-content-xxl-start  trendhead">
                    <p class="h1"><?php echo $story['main_title']; ?><img class="mx-5 px-5  pb-5" src="<?php bloginfo('template_directory'); ?>./Assets/Images/element3home.png" alt="" srcset=""></p>
                </div>
            ...
            <div class="row ">
                <div class="col-auto align-self-center mt-5 p-0">
                    <img class="mt-5 pt-5 me-5 " src="<?php bloginfo('template_directory'); ?>./Assets/Images/element1home.png" alt="">
                </div>
