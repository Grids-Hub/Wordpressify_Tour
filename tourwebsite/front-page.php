...
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-auto mb-xl-5  pb-xl-5 mb-sm-0 pb-sm-0 mb-0 pb-0 align-self-center ">
                <img src="<?php bloginfo('template_directory'); ?>./dist/images/element2home.png" alt="">
            </div>
            <div class="col">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-md-12">
                        ...
                        <div class="selector ">
                            ...
                            <div class="d-flex justify-content-end">
                                <img src="<?php bloginfo('template_directory'); ?>./dist/images/element1home.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-lg-6 col-md-12 image ">
                        <img src="<?php bloginfo('template_directory'); ?>./dist/images/element3home.png" alt="">
    ...
    <div class="container my-5 py-5" id="about">
        <div class="row second pt-5">
            <div class="col-xxl-6 col-lg-6 col-md-12 order-xxl-first order-xl-first order-lg-first order-md-last  order-sm-last order-last  secondimage">
                <img class="img-responsive text-md-center" src="<?php echo $about['image']; ?> " alt="" srcset="">
            </div>
            <div class="col-xxl-6 col-lg-6 col-md-12 secondtext text-xxl-start text-xl-start text-lg-start text-md-center text-sm-center text-center align-self-center">
                <p class="h2 mx-xl-5 pe-xl-5 p-0"><?php echo $about['about_title']; ?></p>
                <p class=" mx-xl-5 pe-xl-5 p-0"><?php echo $about['about_para']; ?> </p>
                <div class="d-flex justify-content-end mx-5 px-5">
                    <img class="mx-5 px-5" src="<?php bloginfo('template_directory'); ?>./dist/images/element1home.png" alt="" srcset="">
                </div>
    ...
    <!-- Feature Destination -->
   <?php   if (have_rows('feature_destination')) :  // check if the repeater field has rows of data   ?>
            <div class="container my-5 py-5 " id="destination">
                <div class="row mx-5 features">
                    <div class="col-xxl col-lg-6 col-md-12  d-flex justify-content-md-center justify-content-lg-start justify-content-xxl-start featureshead">
                        <p class="h1"><?php echo $feature['title']; ?></p></p>
                    </div>
                    <div class="col-xxl col-lg-6 col-md-12 d-flex justify-content-end featureview">
                        <?php if ($feature['link']) : ?>
                            <a href="<?php echo $feature['link']; ?>" class="text-warning"><img class="mx-5 px-5  pb-5" src="<?php bloginfo('template_directory'); ?>./dist/images/element1home.png" alt="" srcset="">
                ...
                <div class="row featureimg">
                    <div class="col-auto align-self-center ">
                        <img class="mt-5 pt-5" src="<?php bloginfo('template_directory'); ?>./dist/images/element3home.png" alt="">
                    </div>
        ...
        <div class="row guide pt-5">
            <div class="col-xxl-6 col-lg-6 col-md-12 guidetext text-xxl-start text-xl-start text-lg-start text-md-center text-sm-center text-center align-self-center">
                <div class="d-flex justify-content-start mx-5 py-5 px-5">
                    <img src="<?php bloginfo('template_directory'); ?>./dist/images/element1home.png" alt="" srcset="">
                </div>
                <p class="h2 mx-xl-5 pe-xl-5 p-0"><?php echo $guide['title']; ?> </p>
                <p class=" mx-xl-5 pe-xl-5 p-0"><?php echo $guide['para']; ?> </p>
                <div class="d-flex justify-content-center justify-content-xl-start justify-content-lg-start">
                    <?php if ($guide['link']) : ?>
                ...
                <div class="d-flex justify-content-end mx-5 px-5">
                    <img src="<?php bloginfo('template_directory'); ?>./dist/images/element3home.png" alt="" srcset="">
                </div>
            </div>
    ...
    <div class="container testimonials my-5 py-5">
        ...
        <div class="row">
            <div class="col-auto  pe-4 align-self-center">
                <img src="<?php bloginfo('template_directory'); ?>./dist/images/testiimagelement1.svg" alt="" srcset="">
            </div>
                        ...
                        <div class="card-img-overlay p-0">
                            <div class="row h-100">
                                <div class="col-auto cardleft">
                                    <div class="cardplus">
                                        <img src="<?php bloginfo('template_directory'); ?>./dist/images/testiimagelement.svg" alt="" srcset="">
                                    </div>
                                </div>
                                <div class="col cardright">
                                    <div class="row">
                                        <div class="col  cardcircle">
                                            <img src="<?php bloginfo('template_directory'); ?>./dist/images/testiimagelement2.svg" alt="" srcset="">
                                        </div>

                                        <div class=" cardarrow">
                                            <div class="arrow ">
                                                <button class="border rounded-circle ms-4 py-2 px-2 text-secondary" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev"><i class="bi bi-chevron-left"></i></button>
                                                <button class="border rounded-circle p-2 text-dark border-dark" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next"><i class="bi bi-chevron-right"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container trending my-5 py-5">
        <div class="row mx-5  ">
            <div class="col-xxl col-lg-6 col-md-12  d-flex justify-content-md-center justify-content-lg-start justify-content-xxl-start  trendhead">
                <p class="h1"><?php echo $story['main_title']; ?><img class="mx-5 px-5  pb-5" src="<?php bloginfo('template_directory'); ?>./dist/images/element3home.png" alt="" srcset=""></p>
            </div>
        ...
        <div class="row ">
            <div class="col-auto align-self-center mt-5 p-0">
                <img class="mt-5 pt-5 me-5 " src="<?php bloginfo('template_directory'); ?>./dist/images/element1home.png" alt="">
            </div>
