...
//CSS
function add_css() {
   wp_register_style('font', get_template_directory_uri() . './build/css/main.css', false,'1.1','all');
...
function add_js(){
   wp_register_script('JS', get_template_directory_uri() . './build/js/script.js', false,'1.1','all');
